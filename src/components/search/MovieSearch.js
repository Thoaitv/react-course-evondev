// https://api.themoviedb.org/3/movie/550?api_key=1b0f7fb1bc355629765f8261af85dc71
// https://api.themoviedb.org/3/search/movie?api_key=1b0f7fb1bc355629765f8261af85dc71&query=%27%27
...
const MovieSearch = () => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      const response = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=1b0f7fb1bc355629765f8261af85dc71&query='${queryDebounce}'`);
      ...
      <div className="bg-white p-3 rounded-2xl shadow-md flex flex-col">
        ...
        <div className="p-7 flex-1 flex flex-col">
          ...
          <p className="text-[#999] text-sm mb-6 !leading-loose">
            <LoadingSkeleton width="100%" height="10px" radius="5px"/>
          ...
          <div className="flex items-center gap-x-3 mt-auto">
            ...
            <span className="text-sm font-semibold text-[#333]">
              <LoadingSkeleton width="50px" height="10px" radius="5px"/>
          </span>
          </div>
        </div>
      </div>
